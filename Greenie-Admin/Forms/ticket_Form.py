...
class TicketForm():
    def __init__(self, panel_principal):
        self.panelprincipal = tk.Frame(panel_principal)
        self.panelprincipal.pack(fill="both", expand=True)

        tk.Label(self.panelprincipal, text="📋 Lista de Tickets Recibidos", font=("Arial", 16), bg="white").pack(pady=10)

        # --- Filtro ---
        filtro_frame = tk.Frame(self.panelprincipal, bg="white")
        ...
        contenedor = tk.Frame(self.panelprincipal)
        ...
        # --- Botón para resolver ---
        tk.Button(self.panelprincipal, text="✅ Marcar como resuelto", command=self.resolver_ticket, bg="#007bff", fg="white").pack(pady=10)
