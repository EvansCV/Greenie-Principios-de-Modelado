...
from Forms.ventas_Form import Ventas_Form
import config
#---------------------------------------------------------/
...
from Forms.equipos_form import Equipos_Form
...
class Master_Form(tk.Tk):
    ...
    def controles_menu_lateral(self):
        ...
        buttons_info = [
            ...
            ("Equipos", self.iconTickets, tk.Button(self.menu_lateral), self.abrir_panel_equipos),
            ("Ventas", self.iconTickets, tk.Button(self.menu_lateral), self.abrir_panel_ventas),
    ...
    def abrir_panel_equipos(self):
        self.limpiar_panel(self.cuerpo_principal)
        Equipos_Form(self.cuerpo_principal)

    def abrir_panel_ventas(self):
        self.limpiar_panel(self.cuerpo_principal)
        Ventas_Form(self.cuerpo_principal)
